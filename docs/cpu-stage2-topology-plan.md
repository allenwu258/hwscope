...
1. Add focused tests for mask range compression, cache grouping and CPU visual adapter conversion.
2. Continue the drawn topology visualization work: extract selection/highlight/details services and add PNG/JSON export. See `docs/cpu-topology-visualization-plan.md`.
3. Add richer L3 sharing summary and optional CCD/V-Cache heuristic insight, clearly marked as inferred.
